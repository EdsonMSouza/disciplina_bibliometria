...
- Aplicar IA Generativa para interpretação automatizada e assistida de métricas.
...
| **Fontes de Dados & APIs** | Scopus, Web of Science, OpenAlex API, ProQuest, IEEE |
| **Visualização de Redes** | VOSviewer, Gephi, Litmaps, CitNetExplorer |
| **IA & Análise** | IA Generativa (LLMs), Jupyter Notebooks, OpenRefine |
...
| 07 | IAGen na Interpretação Bibliométrica | Jupyter, LLMs |
| 08 | Redes de Coautoria e Cocitação | VOSviewer, Gephi |
| 09 | Visualização e Dashboards Científicos | Plotly |
| 10 | Altmetria e Ciência Aberta (OSF) | Altmetric Explorer, OSF |
| 11 | Topic Modeling e Análise de Tendências | Scikit-learn (LDA) |
| 12 | Governança da IA e Ética Científica | AIGen (Análise Ética) |
| 13 | Projeto Final: Planejamento e Integração | Revisão Textual com IA |
| 14 | Projeto Final: Aplicação e Consolidação | Edição ABNT, Upload OSF |
| 15 | Apresentação e Reflexão Ética | Seminário Final |
